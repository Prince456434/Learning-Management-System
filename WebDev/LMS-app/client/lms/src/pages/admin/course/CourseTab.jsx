...
import {
 ...
 // useGetCreatorCourseQuery
   //usePublishCourseMutation, //  Uncommented import
...
const CourseTab = () => {
  ...
  const courseId = params.courseId;
   const {data:courseByIdData,isLoading:courseByIdLoading}=useGetCourseByIdQuery();
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row justify-between">
        ...
        <Button disabled={courseByIdData?.course.lectures.length === 0} variant="outline" onClick={()=> publishStatusHandler(courseByIdData?.course.isPublished ? "false" : "true")}> {courseByIdData?.course.isPublished ? "Unpublished" : "Publish"}
          </Button>
