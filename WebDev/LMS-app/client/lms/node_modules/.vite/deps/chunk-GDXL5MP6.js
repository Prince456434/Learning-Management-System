...
var Slot3 = React8.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children });
});
Slot3.displayName = "Slot";
var SlotClone3 = React8.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable3(child) {
  return React8.isValidElement(child) && child.type === Slottable3;
}
...
//# sourceMappingURL=chunk-GDXL5MP6.js.map
